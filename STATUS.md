...
- [x] 7.1 Embed Pencil Editor in LiteCMS Admin — ready
...
- **7.2 .pen-to-HTML Converter (PenConverter)**: plan: **no — create first**, prompt: **no — create first**, tests: **no — create first**
